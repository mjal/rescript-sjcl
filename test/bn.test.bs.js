...
Zora.test("Bignum modular reduction test", (function (t) {
        var a = new SjclComplete.bn(bn_mod.a);
        var n = new SjclComplete.bn(bn_mod.N);
        var r = a.mod(n);
        var res = r.equals(new SjclComplete.bn(bn_mod.r));
        t.equal(res, true, "Should match");
      }));

Zora.test("Bignum modular multiplication test", (function (t) {
        var a = new SjclComplete.bn(bn_mulmod.a);
        var b = new SjclComplete.bn(bn_mulmod.b);
        var n = new SjclComplete.bn(bn_mulmod.N);
        var r = a.mulmod(b, n);
        var res = r.equals(new SjclComplete.bn(bn_mulmod.r));
        t.equal(res, true, "Should match");
      }));
...
Zora.test("Bignum modular exponentiation test", (function (t) {
        for(var i = 0 ,i_finish = bn_powermod.length; i < i_finish; ++i){
          ...
          var g = new SjclComplete.bn(tv.g);
          var x = new SjclComplete.bn(tv.x);
          var n = new SjclComplete.bn(tv.N);
          var v = g.powermod(x, n);
          t.equal(v.equals(new SjclComplete.bn(tv.v)), true, "Should match");
        }
      }));

Zora.test("Bignum toString test", (function (t) {
        var res = new SjclComplete.bn("bbdf72").power(10).toString();
